...
export const GlobeClock = ({
  ...
  return html`
    <svg
      ...
      role="img"
      fill="currentColor"
      aria-labelledby="${`title-GlobeClock-${count}`}"
      aria-describedby="${`title-GlobeClock-${count}`}"
    >
      <title id="${`title-GlobeClock-${count}`}">${title}</title>
      ${desc
        ? html`
            <desc id="${`desc-GlobeClock-${count}`}">${desc}</desc>
          `
        : html``}
      <path
      ...
      />
      <path
        d="M37.526 35.995v-5.22a1.652 1.652 0 00-1.652-1.652 1.652 1.652 0 00-1.652 1.652v7.04l4.134 2.613a1.652 1.652 0 002.28-.513 1.652 1.652 0 00-.513-2.28z"
      />
    </svg>
  `;
};
